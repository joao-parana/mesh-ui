...
@Component({
    ...
    templateUrl: './project-detail-microschemas.component.html',
    styleUrls: ['./project-detail-microschemas.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class ProjectDetailMicroschemasComponent implements OnInit, OnDestroy {
    ...
    public schemas$: Observable<Microschema[]>;
    public allSchemas$: Observable<Microschema[]>;
    public projectSchemas$: Observable<MicroschemaReference[] | undefined>;
    ...
    ngOnInit() {
        ...
        this.allSchemas$ = this.entities.selectAllMicroschemas();
    ...
    onSchemaAssignmentChange(schema: Schema, isChecked: boolean): void {
        ...
        if (isChecked) {
            this.schemaEffects
                .assignEntityToProject('microschema', schema.uuid, this.project.name)
                .then(() => this.listEffects.loadMicroschemasForProject(this.project.name));
        } else {
            this.schemaEffects
                .removeEntityFromProject('microschema', schema.uuid, this.project.name)
                .then(() => this.listEffects.loadMicroschemasForProject(this.project.name));
        }
    }
}
